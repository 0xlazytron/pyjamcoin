...
import Icon from '@/public/images/about-icon.png'
  ...
  <section className="relative">
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="pt-32 pb-10 md:pt-40">
        ...
        {/* Hero content */}
        <div className="text-center mt-28 pt-4">
          <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-6 pt-12">The folks behind the PyjamaCoin</h1>
          {/* Rings illustration */}
          <div className="inline-flex items-center justify-center relative">
            ...
            <Image className="absolute ms-[2%] mt-[0%] drop-shadow-lg animate-float" src={Icon} width={100} height={100} alt="About icon" />
          </div>
        </div>
