    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          {/* Content */}
          <div className="max-w-3xl mx-auto text-center mb-5 md:mb-0">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">Join the Fun</div>
            </div>
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Start Earning Pyjama Coins Today!</h2>
            <p className="text-lg text-slate-400 mb-8">Experience the joy of gaming and earning with Pyjama Coin. Get started now and watch your rewards grow!</p>
