export const metadata = {
  title: 'Changelog - PyjamaCoin - weekly updates about our app',
  description: 'We will inform you every week about updates on our app and are happy to take your feedback into account in the implementation',
}
      ...
      <section className="relative">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            {/* Page header */}
            <div className="text-center pb-12 md:pb-20 pt-44 ">
              ...
              <div className="max-w-3xl mx-auto">
                <p className="text-lg text-slate-400">New updates and improvements to PyjamaCoin.</p>
              </div>
            </div>
